      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm space-y-4">
          <div className="flex justify-between items-center pb-3 border-b border-gray-100">
            <span className="text-gray-600">Arvioitu kesto</span>
            <span className="text-lg font-semibold text-gray-800">
              {estimatedTime} tuntia
            </span>
          </div>

          <div className="flex justify-between items-center pb-3 border-b border-gray-100">
            <span className="text-gray-600">Hinta (sis. ALV)</span>
            <span className="text-lg font-semibold text-gray-800">
          ...
          <div className="flex justify-between items-center pb-3 border-b border-gray-100">
            <span className="text-gray-600">Hinta (ALV 0%)</span>
            <span className="text-lg font-semibold text-gray-800">
          ...
          <div className="flex justify-between items-center pb-3">
            <span className="text-gray-600">Kotitalousvähennyksen jälkeen</span>
            <span className="text-xl font-bold text-[#27ae60]">
              {priceAfterDeduction.toFixed(2)} €
            </span>
          </div>
