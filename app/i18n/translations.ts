export const translations = {
    ...
    priceCalculator: {
      title: 'Hinta-arvio',
      subtitle: 'Laske siivouspalvelun hinta-arvio',
      roomsLabel: 'Huoneiden määrä',
      sizeLabel: 'Asunnon koko (m²)',
      frequencyLabel: 'Siivoustiheys',
      ...
      euro: '€',
      timeEstimate: 'Arvioitu kesto:',
      hours: 'tuntia',
      priceNote: 'Huomaa: Tämä on alustava arvio. Lopullinen hinta voi vaihdella riippuen asunnon kunnosta ja erityisvaatimuksista.',
      priceEstimator: 'Hinta-arvio',
      estimatedTime: 'Arvioitu kesto',
      priceWithVAT: 'Hinta (sis. ALV)',
      priceWithoutVAT: 'Hinta (ALV 0%)',
      priceAfterDeduction: 'Kotitalousvähennyksen jälkeen',
      basicCleaning: 'Perussiivous',
    ...
    contactDesc: 'Kysy palveluistamme tai pyydä tarjous',
    formName: 'Nimi',
    ...
    formErrorGeneric: 'Viestin lähetyksessä tapahtui virhe. Yritä myöhemmin uudelleen.',
    locationTitle: 'Sijainti',
    emailTitle: 'Sähköposti',
    phoneTitle: 'Puhelin',
    ourLocation: 'Toimialueemme',
    thanksMessage: 'Kiitos yhteydenotostasi!',
    willContactSoon: 'Olemme sinuun yhteydessä mahdollisimman pian.',

    // Household Tax Credit
    taxCreditHero: 'Kotitalousvähennys',
    taxCreditDesc: 'Säästä siivouspalveluista kotitalousvähennyksen avulla',
    whatIsTaxCredit: 'Mikä on kotitalousvähennys?',
    taxCreditExplanation: 'Kotitalousvähennys on verovähennys, jonka voit saada kotitalous-, hoiva- tai hoitotyöstä, asunnon kunnossapitotyöstä sekä tietotekniikkalaitteiden asennuksesta ja kunnossapitotyöstä, joka tehdään kodissasi tai vapaa-ajan asunnossasi.',
    benefitsTitle: 'Kotitalousvähennyksen edut',
    benefitsDesc: 'Kotitalousvähennys kannustaa käyttämään ammattilaisten palveluja ja vähentää harmaata taloutta.',
    
    // VAT free cleaning
    vatFreeTitle: 'Arvonlisäveroton siivous',
    vatFreeDesc: 'Arvonlisäveroton (ALV 0 %) siivous yli 80-vuotiaille',
    whatIsVatFree: 'Mitä ALV 0 % tarkoittaa?',
    vatFreeExplained: 'Arvonlisäverolain mukaan kotitalouspalvelut, kuten siivous, voivat olla vapautettuja arvonlisäverosta, kun palvelu tarjotaan yli 80-vuotiaalle henkilölle.',
    vatFreeRequirements: 'Vaatimukset ALV 0 % -palvelulle',
    vatFreeSteps: 'Miten tilata ALV 0 % siivouspalvelu'
  }
};
