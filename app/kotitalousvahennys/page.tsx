        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Kotitalousvähennys on verovähennys, jonka saat teettäessäsi
              kotitaloustyötä, kuten siivousta. Vähennys on 35% työn osuudesta
              ja se vähennetään suoraan maksettavasta verostasi.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-lg">
                    Saat meiltä todistuksen verovähennystä varten
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="bg-[#27ae60] bg-opacity-10 rounded-full p-2 mr-4 mt-1">
                  ...
                  <p className="text-lg">
                    Ilmoita vähennys veroilmoituksessasi
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start max-w-3xl mx-auto">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4">
                  Kotitalousvähennyksen enimmäismäärä on 1600€ per työssäkäyvä
                  henkilö vuodessa.
                </p>
                <div className="bg-gray-50 rounded-lg p-6">
                  <p className="text-lg font-semibold">
                    Esimerkki: Jos taloudessasi on kaksi työssäkäyvää henkilöä,
                    voitte saada yhteensä 3200€ vähennystä vuodessa!
                  </p>
                </div>
              </div>
            </div>
